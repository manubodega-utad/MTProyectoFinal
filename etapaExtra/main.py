import taichi as ti
import numpy as np
from shared.parameters import res, s_force, density_color
from shared.utils import density_source_rgb, set_boundaries, add_forces
...
def main():
    ...
    while window.running:
        input_data = np.zeros(8, dtype=np.float32)
